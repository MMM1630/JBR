...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='HelpedNeedyPhoto',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(upload_to='helped_needy_profiles/photos/', verbose_name='Фото')),
                ('helped_needy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jbr.helpedneedy', verbose_name='Фото нужадющегося')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('needy_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jbr.needyprofile', verbose_name='Документы нуждающегося')),
            ],
            options={
